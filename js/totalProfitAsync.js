...
function setup(){
	...
	$("#mike_easy").click(function(){
		...
		var total_bought = get_total_bought(api_key, 0);
		var total_sold = get_total_sold(api_key, 0);
...
function get_total_bought(api_key, page){
	...
	$.ajax({
		...
		success: function(data, textStatus, request) {
			...
			total_pages = request.getResponseHeader('X-Page-Total') - 1;
			...
			console.log("bought -> "+page_number);
		},
		error: function(data) { 
